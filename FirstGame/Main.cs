...
public class Main : Node
{
    ...
    {
        GetNode("Player").Connect("Hit", this, nameof(GameOver));
        ...
        GetNode("HUD").Connect("StartGame", this, nameof(NewGame));
    }
...
//  }
    ...
    public void OnMobTimerTimeout()
    {
        ...
        mobInstance.LinearVelocity = new Vector2(
            RandRange(mobInstance.MinSpeed, mobInstance.MaxSpeed), 0)
            .Rotated(direction);
    }
